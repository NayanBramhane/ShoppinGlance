...
namespace ShoppingSite
{
    public partial class ManDenims : System.Web.UI.Page
    {
        ...
        //    using (MySqlConnection con = new MySqlConnection(CS))
        //    {
        //        using (MySqlCommand cmd = new MySqlCommand("procBindAllProductsMansDenimFilter", con)) //make a stored procedure to find denims
        //        {
        //            cmd.CommandType = CommandType.StoredProcedure;
        //            cmd.Parameters.AddWithValue("_TXT", txtFilterGrid1Record.Text);
        //            using (MySqlDataAdapter sda = new MySqlDataAdapter(cmd))
        //            {
        //                DataTable dt = new DataTable();
        //                sda.Fill(dt);
