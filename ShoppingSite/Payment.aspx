<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="ShoppingSite.Payment" %>
            ...
            <div class="tab-content">
             ...
             <div class="tab-content">
                 <div id="PlaceNPay" class="tab-pane fade in active">
                     <h3>Place your order and Pay using our <a href="acceptedpayments" target="_blank">Accepted Payments</a> channels, 
                         Your order will be dispatched upon receiving full payment.</h3>
                     <asp:Button ID="BtnPlaceNPay" CssClass=" btn btn-info" Font-Size="Large" ValidationGroup="PaymentPage" runat="server" 
                         OnClick="BtnPlaceNPay_Click" Text="Checkout &raquo;" />
